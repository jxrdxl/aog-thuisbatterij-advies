...
import { CheckCircle, Zap, Phone, Star, ShieldCheck } from "lucide-react";
...
export default function Home() {
  return (
    <div className="min-h-screen flex flex-col selection:bg-aog-green/30">
      ...
      {/* HERO + FORM SECTION - MOBILE FIRST OPTIMIZATION */}
      <section className="relative min-h-[100svh] flex flex-col items-center justify-start overflow-hidden pt-20 sm:pt-24">
        {/* Background */}
        ...
        <div className="relative z-10 container w-full flex flex-col items-center justify-start px-4">
          
          {/* URGENCY BANNER - MOVED TO TOP OF HERO */}
          <div className="w-full max-w-2xl mb-6 animate-slide-up">
            <div className="bg-amber-500/10 backdrop-blur-md border border-amber-500/30 rounded-2xl p-4 flex items-center gap-3 shadow-xl">
              <div className="w-10 h-10 rounded-full bg-amber-500 flex items-center justify-center shrink-0 animate-pulse">
                <Zap className="w-6 h-6 text-white fill-current" />
              </div>
              <div>
                <p className="text-amber-400 font-black text-sm sm:text-base uppercase tracking-wider">
                  Nog beschikbaar deze week
                </p>
                <p className="text-white/80 text-xs sm:text-sm font-medium">
                  Gemiddelde terugbeltijd: <strong className="text-white font-black">47 minuten</strong>
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="text-center mb-6 sm:mb-10 max-w-3xl">
            <h1 className="text-3xl sm:text-5xl lg:text-6xl font-black text-white leading-[1.2] mb-3 text-balance">
              Wat kost uw zonnepanelen u in <span className="text-aog-orange">2027?</span>
            </h1>
            <p className="text-sm sm:text-lg text-white/70 font-medium leading-relaxed">
              De saldering verdwijnt. Ontdek in 2 minuten uw besparing.
            </p>
          </div>
          ...
          {/* ELEVATED TRUST SIGNALS - DIRECTLY BELOW FORM */}
          <div className="mt-8 w-full max-w-2xl">
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 items-center justify-center grayscale opacity-60 hover:grayscale-0 hover:opacity-100 transition-all duration-500">
              <div className="text-center"><p className="text-[10px] sm:text-xs font-black text-white uppercase tracking-widest">FD.nl</p></div>
              <div className="text-center"><p className="text-[10px] sm:text-xs font-black text-white uppercase tracking-widest">RTL Nieuws</p></div>
              <div className="text-center"><p className="text-[10px] sm:text-xs font-black text-white uppercase tracking-widest">NOS.nl</p></div>
              <div className="text-center"><p className="text-[10px] sm:text-xs font-black text-white uppercase tracking-widest">Consumentenbond</p></div>
            </div>
            
            <div className="mt-8 flex flex-wrap items-center justify-center gap-x-6 gap-y-3 text-white/60 text-[10px] sm:text-xs font-black uppercase tracking-[0.2em]">
              <div className="flex items-center gap-1.5">
                <ShieldCheck className="w-4 h-4 text-aog-green" />
                <span>Onafhankelijk</span>
              </div>
              <div className="flex items-center gap-1.5">
                <Star className="w-4 h-4 text-aog-orange fill-current" />
                <span>4.9/5 Google</span>
              </div>
              <div className="flex items-center gap-1.5">
                <CheckCircle className="w-4 h-4 text-aog-green" />
                <span>Warmtefonds 0%</span>
              </div>
            </div>
          </div>
        </div>
